...
from src.ui.pages.servers_page.components.server_details_shower import show_server_details
...
def server_card(
    ...
    if server.ctid in state.servers.updating_servers_ctids:
        return progress_ring()

    return ft.GestureDetector(
        on_tap=open_details,
        on_long_press=open_actions_menu,
        content=ft.Card(
            elevation=3,
            ...
            content=ft.Container(
                ...
                content=ft.Column(
                    [
                        ...
                        ft.Row([ft.Icon(ft.Icons.MEMORY, color=ft.Colors.BLUE_GREY_400),
                                ft.Text(server.get_os_name, size=15)], spacing=8),
