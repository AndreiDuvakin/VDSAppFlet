...
from app.services.ssh_keys_service import SSHKeysService
...
def ssh_keys_tab(
    ...
    if not state.ssh_keys.items and not state.ssh_keys.loading and not state.ssh_keys.error:
        page.run_task(service.load_ssh_keys, state)
